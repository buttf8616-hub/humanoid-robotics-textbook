...
(module.exports = {
  ...
  tagline: 'A comprehensive guide to Physical AI and Humanoid Robotics using Docusaurus',
  url: 'https://humanoid-robotics-textbook-nu.vercel.app',
  baseUrl: '/',
  trailingSlash: false,
  onBrokenLinks: 'throw',
